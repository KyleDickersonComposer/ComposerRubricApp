public class TechnicalSkillsData : ICategoryData
{
    ...
    public TechnicalSkillsData()
    {
        ...
        gi.Add("Grade 3 is the level of most composers who have some understanding of what their software does but they haven't invested enough time to develop mastery of everything. This composer typically doesn't use a template and rebuilds everything from scratch every track. They use the mouse for everything and lack even the most back keybinds. This composer though is able to good results.");
