public class TechnicalSkillsData : ICategoryData
{
    ...
    public TechnicalSkillsData()
    {
        ...
        gi.Add("Grade 4 is the probably the level that is required to start working as an intern or studio assistant. Young composers should focus on this area if they want to make themselves useful while they build all of their other skills. These composers have a good understanding of their software but they don't use it quite as efficiently as the composers from grade 5. Here are some things grade 4s do: Familiar with routing, DSP, file formats/codecs and their settings, Understand all of the functionality of their software, Good project organization, Overuse of the mouse, Lack of knowing all of the relevant keybinds.");
        gi.Add("Grade 3 is the level of most composers who have some understanding of what their software does but they haven't invested enough time to develop mastery of everything. This composer typically doesn't use a template and rebuilds everything from scratch every track. They use the mouse for everything and lack even the most basic keybinds. This composer though is able to produce good results.");
        gi.Add("Grade 2 is the level of someone who only uses prepackaged resources with zero understanding of how to reconstruct them. There is a low level of understanding of software functionality. This composer struggles with the software and fails to produce good results most of the time. This composer spends a very long time on a given track.");
