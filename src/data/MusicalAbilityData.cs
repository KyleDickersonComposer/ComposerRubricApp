public class MusicalAbilityData : ICategoryData
{
    ...
    public MusicalAbilityData()
    {
        ...
        Info = "This is your musical talent and craft. It has virtually zero influence on your ability to get a job (or successfully fulfill its requirements), but other composers recognize it as extremely valuable and admirable.";
        ...
        gi.Add("Grade 5 composers are musicians out of music school who have an elite background. They often have high-level performance experience, advanced music composition/arranging, or a jazz improvisation background. These composers could be successful as professional musicians on their own and are versatile and highly valuable as a composer's assistant.");
