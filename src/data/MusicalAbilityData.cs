public class MusicalAbilityData : ICategoryData
{
    ...
    public MusicalAbilityData()
    {
        ...
        Info = "This is your musical talent and craft. It has virtually zero influence on your ability to get a job, but other composers recognize it as extremely valueable and admirable.";

        List<string> gi = new List<string>();
        gi.Add("Grade 10 is the highest level of music ability and there are few living people who are able to attain it. Musicians at this level are close to the musical proficiency of a great composer but use their skills for a more practical end. Some musicians at this level are: Hugo Friedhofer, Miklos Rozsa, Bernard Herrmann, Conrad Salinger, Henry Mancini, John Scott Trotter, Barry Harris, John Clayton, Sammy Nestico, Bill Holman, Billy May, Hank Jones.");
        gi.Add("Grade 9 is a similarly unattainable level of musicality, but, you have to draw the line somewhere! You could put virtually any above average composer/arranger from the 50s in this category. Here are some names: Ennio Morricone, Gil Evans, Claus Ogerman, Eddie Sauter, Bill Finegan, Leigh Harline, Frank Churchill, Carl Stalling, Erich Korngold, Chick Corea.");
        ...
        gi.Add("Grade 4 composers are often ghostwriters and co-composers on large projects. They don't have the acclaim of a grade 6 composers and that means they are often working without credit. These composers have a good musical background often stemming from a degree at a music school in instrumental performance or music composition.");
        gi.Add("Grade 3 composers are often talented instrumentalists or producers without a strong musical background. These composers are the ones who work their way up bit by bit often in the hands of a skilled mentor. It may take years before this composers is able to work professionally.");
