public class OrganizationSkillsData : ICategoryData
{
    ...
    public OrganizationSkillsData()
    {
        ...
        Info = "These are extremely underrated skills for any professional let alone composers. The amount of data, communications, and logistical work a composer is overwhelming. This is the majority of what you will be doing by the way.";
