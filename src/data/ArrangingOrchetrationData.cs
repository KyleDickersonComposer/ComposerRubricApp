public class ArrangingOrchetrationData : ICategoryData
{
    public string Name { get; set; }
    public string Info { get; set; }
    public List<string> GradingInfo { get; set; }

    public ArrangingOrchetrationData()
    {
        ...
        gi.Add("Grade 3 is a group of composers that get mixed results in their medium of specization, but can sound good when it works. These composers don't have the tools or knowledge of grades 4 and 5 they rely on their instinct. This arranger can't leave their area of specialization at all.");
        gi.Add("Grade 2 composers are beginners who have a very limited understanding of instruments and music in general. They don't know basics of orchestration like instrument registers or the dynamic capabilities of said registers. The lack a realistic of what the instrument sound like in combination or by themselves because of lack of experience interacting with and writing for musicians. This composer has heard the word arrangement and kind of understands what it does but has no real knowledge of it.");
